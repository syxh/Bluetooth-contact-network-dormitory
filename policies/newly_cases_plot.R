...
paneller_CI = function(file,dormID,scenario_id)
{
  ...
  {
    output <- read.csv(paste0('policies/output/data/Scenario_',scenario_id,'_acacia_daily.csv'))
    ylabel = "New cases"
    mastercol = 'darkorange'#'#ed2939'
  }else{
    output <- read.csv(paste0('policies/output/data/Scenario_',scenario_id,'_cassia_daily.csv'))
    ylabel = "New cases"
...
paneller_CI(file='policies/output/plot/acacia_newdorm_s1_ci_epi.png',dormID = 1,scenario_id = 1)
paneller_CI(file='policies/output/plot/cassia_newdorm_s1_ci_epi.png',dormID = 2,scenario_id = 1)

paneller_CI(file='policies/output/plot/acacia_newdorm_s2_ci_epi.png',dormID = 1,scenario_id = 2)
paneller_CI(file='policies/output/plot/cassia_newdorm_s2_ci_epi.png',dormID = 2,scenario_id = 2)

paneller_CI(file='policies/output/plot/acacia_newdorm_s3_ci_epi.png',dormID = 1,scenario_id = 3)
paneller_CI(file='policies/output/plot/cassia_newdorm_s3_ci_epi.png',dormID = 2,scenario_id = 3)

paneller_CI(file='policies/output/plot/acacia_newdorm_s4_ci_epi.png',dormID = 1,scenario_id = 4)
paneller_CI(file='policies/output/plot/cassia_newdorm_s4_ci_epi.png',dormID = 2,scenario_id = 4)

paneller_CI(file='policies/output/plot/acacia_newdorm_s5_ci_epi.png',dormID = 1,scenario_id = 5)
paneller_CI(file='policies/output/plot/cassia_newdorm_s5_ci_epi.png',dormID = 2,scenario_id = 5)

paneller_CI(file='policies/output/plot/acacia_newdorm_s6_ci_epi.png',dormID = 1,scenario_id = 6)
paneller_CI(file='policies/output/plot/cassia_newdorm_s6_ci_epi.png',dormID = 2,scenario_id = 6)

paneller_CI(file='policies/output/plot/acacia_newdorm_s7_ci_epi.png',dormID = 1,scenario_id = 7)
paneller_CI(file='policies/output/plot/cassia_newdorm_s7_ci_epi.png',dormID = 2,scenario_id = 7)

# paneller = function(file,dormID,scenario_id)
# {
#   if(dormID%in%c(1,'Acacia','acacia'))
#   {
#     output <- read.csv(paste0('policies/working/combine_Scenario_',scenario_id,'_theta_acacia_daily.csv'))
#     ci <- read.csv(paste0('policies/output/data/Scenario_',scenario_id,'_acacia_daily.csv'))
#     ylabel = "Newly cases"
#     leg_label = "Smaller outbreak"
#   }else{
#     output <- read.csv(paste0('policies/working/combine_Scenario_',scenario_id,'_theta_cassia_daily.csv'))
#     ci <- read.csv(paste0('policies/output/data/Scenario_',scenario_id,'_cassia_daily.csv'))
#     ylabel = "Newly cases"
#     leg_label = "Larger outbreak"
#     
#   }
#   t  = c(1:nrow(output))
#   oC = ci$central
